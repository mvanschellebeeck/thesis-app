...
export default function MeasureBar({salinity}) {



  const salinityScaler = (salinity) => {
    const old_range = 10000 - 0;
  ...
  return (
    <ProgressBar
      ...
      label={<Typography style={{fontSize: 9, color: 'black', marginLeft: '5px'}}>{salinity + ' mg/L'}</Typography>}
